<template>
  <div :class="$style.cryptoTerminal">
    <a-select showSearch defaultValue="btc" :style="{width: '100%'}" class="d-lg-none mb-3">
    ...
    <div :class="$style.listContainer">
      <div v-sticky="{ stickyTop: 30 }">
        <div>
          <div class="rounded bg-gray-1" :class="$style.list">
            <vue-custom-scrollbar style="height: 100%">
              <a href="javascript: void(0);" :class="$style.item" class="p-1">
                <div class="font-size-16 text-uppercase">RVN</div>
                <div class="text-success font-size-14 align-text-bottom">5.2% <span>↑</span></div>
              </a>
              <a href="javascript: void(0);" :class="$style.item" class="p-1 bg-gray-3">
                <div class="font-size-16 text-uppercase">BTC</div>
                <div class="text-success font-size-14 align-text-bottom">1.4% <span>↑</span></div>
              </a>
              <a href="javascript: void(0);" :class="$style.item" class="p-1">
                <div class="font-size-16 text-uppercase">XRP</div>
                <div class="text-danger font-size-14 align-text-bottom">5.2% <span>↓</span></div>
              </a>
              <a href="javascript: void(0);" :class="$style.item" class="p-1">
                <div class="font-size-16 text-uppercase">ADA</div>
                <div class="text-success font-size-14 align-text-bottom">6.8% <span>↑</span></div>
              </a>
              <a href="javascript: void(0);" :class="$style.item" class="p-1">
                <div class="font-size-16 text-uppercase">BSV</div>
                <div class="text-success font-size-14 align-text-bottom">8.9% <span>↑</span></div>
              </a>
              <a href="javascript: void(0);" :class="$style.item" class="p-1">
                <div class="font-size-16 text-uppercase">TUSD</div>
                <div class="text-danger font-size-14 align-text-bottom">5.2% <span>↓</span></div>
              </a>
              <a href="javascript: void(0);" :class="$style.item" class="p-1">
                <div class="font-size-16 text-uppercase">MTL</div>
                <div class="text-success font-size-14 align-text-bottom">8.9% <span>↑</span></div>
              </a>
              <a href="javascript: void(0);" :class="$style.item" class="p-1">
                <div class="font-size-16 text-uppercase">RVN</div>
    ...
    <div :class="$style.content">
      <div class="d-flex mb-3 flex-wrap">
        <div class="d-flex align-items-center flex-nowrap flex-fill pr-2">
          <div class="mr-3">
            <img src="resources/images/icons/bitcoin.png" alt="Bitcoin">
          </div>
          <div>
            <div class="font-weight-bold text-dark font-size-18 text-nowrap">BTC-USD</div>
            <div class="font-size-14 text-gray-6 mt-n1">Bitcoin</div>
          </div>
        </div>
        <div class="w-100 d-xl-none mb-2"></div>
        <div class="text-left text-xl-right flex-fill px-sm-2">
          <div class="font-weight-bold text-nowrap">$ <span class="text-success font-size-18">10144.87</span></div>
          <div class="text-uppercase font-size-14 mt-n1">Last</div>
        </div>
        <div class="text-left text-xl-right flex-fill px-sm-2">
          <div class="font-weight-bold text-nowrap">$ <span class="text-danger font-size-18">10144.65</span></div>
          <div class="text-uppercase font-size-14 mt-n1">BID</div>
        </div>
        <div class="w-100 d-sm-none"></div>
        <div class="text-left text-xl-right flex-fill px-sm-2">
          <div class="font-weight-bold text-nowrap">$ <span class="text-danger font-size-18">10144.65</span></div>
          <div class="text-uppercase font-size-14 mt-n1">ASK</div>
        </div>
        <div class="text-left text-xl-right flex-fill px-sm-2">
          <div class="font-weight-bold text-nowrap">$ <span class="text-danger font-size-18">4180496.22</span></div>
          <div class="text-uppercase font-size-14 mt-n1">Volume</div>
        </div>
        <div class="w-100 d-xl-none mb-2"></div>
        <div class="text-left text-xl-right flex-fill align-self-center">
          <button class="btn btn-success btn-with-addon text-nowrap">
      ...
      <div class="card">
        <div class="card-header card-header-flex">
          <a-tabs defaultActiveKey="1" class="air-tabs-bold mr-auto">
            <a-tab-pane tab="MARKET CHART" key="1" />
            <a-tab-pane tab="DEPTH CHART" key="2" />
          </a-tabs>
      ...
      <div class="card">
        <div class="card-body">
          ...
          <div class="d-block d-xl-flex">
            ...
            <div class="width-250 mx-auto mx-xl-4">
      ...
      <div class="card">
        <div class="card-body">
          <h5 class="mb-2">Market History</h5>
          <div class="air__utils__scrollTable">
            <a-table
            ...
            >
              ...
              <span slot="type" slot-scope="value"
                    :style="value === 'SELL' ? { color: '#f75535' } : { color: '#00a45b' }">{{value}}</span>
            </a-table>
          </div>
        </div>
      </div>
      <div class="card">
        <div class="card-body">
          <h5 class="mb-3">My Open Orders</h5>
          ...
          <div v-if="myOpenOrders.loaded" :class="$style.loaded" class="air__utils__scrollTable">
            <a-table
      ...
      <div class="card">
        <div class="card-body">
          ...
          <div v-if="myOrderHistory.loaded" class="air__utils__scrollTable">
            <a-table
              :columns="myOrderColumns"
