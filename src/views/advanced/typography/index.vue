        ...
        <div class="row">
          <div class="col-lg-4">
            ...
            <div class="mb-5">
              ...
              <p>
                Bootstrap's global default <code>font-size</code> is <strong>1rem</strong>, with a
                <code>line-height</code> of <strong>1.5</strong>. This is applied to the
        ...
        <div class="row">
          <div class="col-lg-4">
            ...
            <div class="mb-5">
              ...
              <ul class="list-unstyled">
                <li>
                  <i class="icmn-checkmark2 mr-2" aria-hidden="true"></i>
                ...
                <li>
                  <i class="icmn-checkmark2 mr-2" aria-hidden="true"></i>Faucibus porta lacus fringilla
                  vel
                </li>
              </ul>
            </div>
          ...
          <div class="col-lg-4">
            ...
            <div class="mb-5">
              ...
              <p class="text-muted">
                Place all list items on a single line with <code>display: inline-block;</code> and some
                light padding
              </p>
